...
class Fw_Config_Controller extends Fw_Controller {
    ...
    public function config_acl() {
        ...
        parent::display('config_acl', true);
    }

    public function config_scripts() {
        parent::display('config_scripts', true);
    }
    ...
    public function config_configuration() {
        ...
        parent::display('config_configuration', true);
    }
    ...
    public function config_databases() {
        ...
        parent::display('config_databases', true);
    }
    ...
    public function config_routes() {
        ...
        parent::display('config_routes', true);
    }

    public function config_crud() {
        parent::display('config_crud', true);
    }
