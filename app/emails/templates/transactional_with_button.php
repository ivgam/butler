                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
													...
													<tr>
														<td align="center" valign="top" style="padding-top:0;">
															<table border="0" cellpadding="15" cellspacing="0" class="templateButton" style="color:#FFFFFF;font-family:Arial;font-size:15px;font-weight:bold;letter-spacing:-.5px;line-height:100%;text-align:center;text-decoration:none;-moz-border-radius:3px;-webkit-border-radius:3px;background-color:#51a351;border:0;border-collapse:separate !important;border-radius:3px;">
																<tr>
																	<td valign="middle" class="templateButtonContent">
																		<div mc:edit="std_content01">
																			<a href="#BUTTON_LINK#" target="_blank" style="color:#FFFFFF;font-family:Arial;font-size:15px;font-weight:bold;letter-spacing:-.5px;line-height:100%;text-align:center;text-decoration:none;">#BUTTON_TEXT#</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
