<div class="grid_2" id="top-search">	
	...
	<a href="<?php echo Fw_Router::getUrl('minify', 'generateAll')?>" title="CCC(minify CSS&JS)"><span class="ccc"/></a>
	<a href="<?php echo Fw_Router::getUrl('dumper', 'all')?>" title="dump database"><span class="dump_database"/></a>
	<a href="<?php echo Fw_Router::getUrl('dumper', 'schema')?>" title="dump database schema"><span class="dump_schema"/></a>	
